...
#define COLOUR_METALLIC_DARK = 0x808483
#define COLOUR_METALLIC_LIGHT = 0xBFBDC2
#define COLOUR_AMORPHOUS_CARBON = 0x828186
#define COLOUR_LEMON_YELLOW = 0xF19EED
#define COLOUR_METALLIC_BROWN = 0x584E44
#define COLOUR_METALLIC_SHINY = 0xBCBFC6
